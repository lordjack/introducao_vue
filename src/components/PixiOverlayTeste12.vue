    ...
    <div style="height: 800px; width: 100%">
      ...
      <div id="details">
        <div class="results">
          <div class="header">
            <span class="nom"
              >{{ legenda.nom }}({{ legenda.dpt }}, {{ legenda.circ }})</span
            ><span class="close"></span>
          </div>
          <table>
            <tbody>
              <tr>
                <td>Inscrits:{{ legenda.inscrits }}</td>
                <td>
                  Abstention:
      ...
      <div id="map" style="height: 100%; width: 100%" class="cartes">
        ...
        <div class="main-legend hide" style="bottom: 125px">
          <ul>
            ...
            <li>
              <span class="color" style="background-color: #23db23"></span>Écologiste
            </li>
              ...
              (() => {
                ...
                async function focusFeature(feat) {
                  ...
                  if (feat) {
                    if (feat.properties.res) {
                      ...
                      vm.legenda = data.data;
                      console.log(vm.legenda);
                ...
                legendContent.addEventListener("click", function (e) {
                  ...
                  if (L.DomUtil.hasClass(target, "close")) {
                    ...
                    focus = null;
                    L.DomUtil.addClass(legend, "hide");
                    console.log("Teste1 Legenda " + legend);
                  }
                });
                window.L.control
                  .photon({
